...
export class LoginComponent implements OnInit {
  ...
  constructor(
    ...
    if (servicioLogin.isLogged()) this.router.navigateByUrl("/artists");
  }
  ...
  async login() {
    ...
    let user: User;
    await this.servicioLogin
      .autenticate(this.username, this.password)
      .subscribe(dataResponse => {
        ...
        if (user != null) {
          ...
          this.message =
            "Error al iniciar sesión, por favor verifique usuario y/o contraseña.";
      });
  }
}
